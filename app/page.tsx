        ...
        <header className="sticky top-0 z-50 bg-background/60 backdrop-blur-md border-b border-border">
          <div className="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/pair" className="ml-2 glow-button px-4 py-2 rounded-lg text-sm font-semibold">Pair Now</Link>
            </nav>
          </div>
        </header>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link href="/pair" className="glow-button px-6 py-3 rounded-lg font-semibold">Get Pair Code</Link>
                ...
                <div className="order-first lg:order-last">
                  <div className="bg-gradient-to-br from-indigo-900/40 to-transparent border border-border rounded-2xl p-8 backdrop-blur-sm">
                    ...
                    <ol className="list-decimal list-inside space-y-3 text-muted-foreground">
                      <li>Click "Get Pair Code" and enter your phone number (with country code)</li>
                    ...
                    <div className="mt-6">
                      <Link href="/pair" className="glow-button px-4 py-2 rounded-lg">Generate Code</Link>
                    </div>
                  </div>
                </div>
              </div>
